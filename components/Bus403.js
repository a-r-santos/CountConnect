...
const Bus403 = () => {
    ...
    const handleLeftArrowClick = () => {
        navigation.navigate('Bus402');
    };

    const handleRightArrowClick = () => {
        navigation.navigate('Bus404');
    };
    ...
    return (
        <View style={styles.container}>
            ...
            <View>
                <Text style={styles.title}>Destination: <Text style={styles.subtitle}>Tagoloan</Text>{' '}
                </Text>
            </View>
            <View style={styles.circleContainer}>
                ...
                <View style={styles.circle}>
                    ...
                    <Text style={styles.number}>403</Text>
                </View>
