...
const Bus204 = () => {
    ...
    const handleLeftArrowClick = () => {
        navigation.navigate('Bus203');
    };

    const handleRightArrowClick = () => {
        navigation.navigate('Bus205');
    };
    ...
    return (
        <View style={styles.container}>
            ...
            <View>
                <Text style={styles.title}>Destination: <Text style={styles.subtitle}>Laguindingan</Text>{' '}
                </Text>
            </View>
            <View style={styles.circleContainer}>
                ...
                <View style={styles.circle}>
                    ...
                    <Text style={styles.number}>204</Text>
                </View>
                <TouchableOpacity onPress={handleRightArrowClick}>
                    <Icon name="chevron-circle-right" size={40} style={styles.arrowIcon} />
                </TouchableOpacity>
            </View>
            <View style={styles.circle}>
