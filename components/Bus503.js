...
const Bus503 = () => {
    ...
    const handleLeftArrowClick = () => {
        navigation.navigate('Bus502');
    };

    const handleRightArrowClick = () => {
        navigation.navigate('Bus504');
    };
    ...
    return (
        <View style={styles.container}>
            ...
            <View>
                <Text style={styles.title}>Destination: <Text style={styles.subtitle}>Villanueva</Text>{' '}
                </Text>
            </View>
            <View style={styles.circleContainer}>
                ...
                <View style={styles.circle}>
                    ...
                    <Text style={styles.number}>503</Text>
                </View>
