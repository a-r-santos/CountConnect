...
const Bus303 = () => {
    ...
    const handleLeftArrowClick = () => {
        navigation.navigate('Bus302');
    };

    const handleRightArrowClick = () => {
        navigation.navigate('Bus304');
    };
    ...
    return (
        <View style={styles.container}>
            ...
            <View>
                <Text style={styles.title}>Destination: <Text style={styles.subtitle}>Libertad</Text>{' '}
                </Text>
            </View>
            <View style={styles.circleContainer}>
                ...
                <View style={styles.circle}>
                    ...
                    <Text style={styles.number}>303</Text>
                </View>
